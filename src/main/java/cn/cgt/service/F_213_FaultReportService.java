...
/**
 * 三、系统维护/过程资料/核心平台/平台故障解决方式汇总/
 * 2.1.3、核心平台-平台故障及解决方式汇总.docx
 *
 * @author HuangZh
 * @date 2022/09/26
 */
@Service
public class F_213_FaultReportService {
    ...
    public void report(String date) {
        String templatePath = reportConfiguration.getTemplatePath() + "项目运维资料/三、系统维护/过程资料/核心平台/平台故障解决方式汇总/2.1.3、核心平台-平台故障及解决方式汇总.docx";
        //加载文档
